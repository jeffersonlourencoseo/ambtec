...
<div class="my-8 p-6 lg:p-8 bg-neutral-cream rounded-xl border border-neutral-ink/5">
  <p class="text-lg font-display font-bold text-neutral-ink mb-2">Precisa de ajuda com o licenciamento ambiental da sua empresa?</p>
...
<div class="my-8 p-6 lg:p-8 bg-neutral-cream rounded-xl border border-neutral-ink/5">
  <p class="text-lg font-display font-bold text-neutral-ink mb-2">Documentação ambiental em atraso?</p>
  <p class="text-neutral-ink-muted mb-4">Nossa equipe oferece diagnóstico gratuito.</p>
  <a href="/contato" class="btn-luxury">Solicitar Proposta Técnica</a>
</div>
